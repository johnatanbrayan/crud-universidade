...
/**admin    admin
 * A DTO representing a professor, with his authorities.
 */
public class ProfessorDTO {
    ...
    public ProfessorDTO(User professor) {
        ...
        this.imageUrl = professor.getImageUrl();
        this.nome = professor.getNome();
        this.dtNascimento = professor.getDtNascimento();
        this.sexo = professor.getSexo();
        this.telCelular = professor.getTelCelular();
        this.activated = professor.getActivated();
        this.logradouro =  professor.getLogradouro();
        this.numero = professor.getNumero();
        this.complemento = professor.getComplemento();
        this.bairro = professor.getBairro();
        this.cidade = professor.getCidade();
        this.uf = professor.getUf();
        this.cep = professor.getCep();
        this.coord = professor.getCoord();
        this.valor = professor.getValor();
        this.token = professor.getToken();
        this.authorities = professor.getAuthorities().stream()
