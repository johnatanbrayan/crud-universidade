...
import com.forquality.crud.service.dto.UserDTO;
...
public class UserService {
    ...
    public User createUser(UserDTO userDTO) {
        ...
        user.setDtNascimento(userDTO.getDtNascimento());
        user.setSexo(userDTO.getSexo());
        user.setTelCelular(userDTO.getTelCelular());
        user.setTelFixo(userDTO.getTelFixo());
        ...
        user.setCoord(userDTO.getCoord());
    ...
    public void updateUser(String nome, String email, String imageUrl) {
    ...
    public Page<User> getManagedUsers(Pageable pageable) {
        return userRepository.buscarPorTipoUsuario(1, pageable);
    }
